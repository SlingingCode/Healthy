...
namespace Healthy.API.Migrations
{
    public partial class SEED : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (21, '2018-01-11', 21, 41, (select top 1 id from Persons where firstname = 'Alice'), 71 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (22, '2018-01-12', 22, 42, (select top 1 id from Persons where firstname = 'Alice'), 71 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (22, '2018-01-12', 22, 42, (select top 1 id from Persons where firstname = 'Håkon'), 72 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (23, '2018-01-13', 23, 43, (select top 1 id from Persons where firstname = 'Håkon'), 73 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (23, '2018-01-13', 23, 43, (select top 1 id from Persons where firstname = 'Nils'), 73 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (24, '2018-01-14', 24, 44, (select top 1 id from Persons where firstname = 'Nils'), 74 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (24, '2018-01-14', 24, 44, (select top 1 id from Persons where firstname = 'Elina'), 74 )");
            migrationBuilder.Sql("INSERT INTO ScaleResults (Bmi, Date, PercentageFat, PercentageMuscles, PersonId, Weight) VALUES (25, '2018-01-15', 25, 45, (select top 1 id from Persons where firstname = 'Elina'), 75 )");
        }
